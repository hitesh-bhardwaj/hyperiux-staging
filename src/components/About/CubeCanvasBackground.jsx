  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      faces.forEach((face, index) => {
        ...
        /*
          Bigger multiplier = faster local fade-in per face.
          Lower it if you want a softer reveal.
        */
        const alpha = gsap.utils.clamp(0, 1, (progress - start) * 18);
    ...
    tweenRef.current = gsap.to(progressRef.current, {
      ...
      onUpdate: draw,
      scrollTrigger: {
        id: "charactersGridCubeLeftToRightReveal",
        trigger: "#what-we",
        start: "20% 50%",
        end: "95% bottom",
        scrub: true,
