...
const ICON_CLASS =
    "w-[2.8vw] h-[2.8vw] relative z-2 duration-500 ease-in-out max-sm:w-[13vw] max-sm:h-[13vw]";
...
function FacebookIcon({ className = "", fill = "" }) {
    return (
        <svg
            ...
            aria-hidden="true"
        >
            <g clipPath="url(#crl-facebook-clip)">
                <path
...
function InstagramIcon({ className = "", fill = "" }) {
    return (
        <svg
            ...
            aria-hidden="true"
        >
            <g clipPath="url(#crl-instagram-clip)">
                <path
                    className={`duration-500 ease-in-out ${fill}`}
            ...
            <defs>
                <clipPath id="crl-instagram-clip">
...
function LinkedinIcon({ className = "", fill = "" }) {
    return (
        <svg
            className={`${ICON_CLASS} ${className}`}
            width="48"
            ...
            aria-hidden="true"
        >
            <g clipPath="url(#crl-linkedin-clip)">
                <path
                    className={`duration-500 ease-in-out ${fill}`}
...
function TwitterIcon({ className = "", fill = "" }) {
    return (
        <svg
            ...
            aria-hidden="true"
        >
            <g clipPath="url(#crl-twitter-clip)">
                <path
                    className={`duration-500 ease-in-out ${fill}`}
...
export default function CircularButton({
    ...
    return (
        <Link
            ...
            className={`rounded-full overflow-hidden socials cursor-pointer relative border border-white w-fit h-fit group duration-500 ease-in-out flex items-center justify-center ${menuSocial ? "menusocials" : "hover:border-[#ff5f00]"
                }`}
        ...
        >
            ...
            <span className="relative z-2 flex items-center justify-center">
                {Icon ? <Icon className={className} fill={fill} /> : children}
            </span>
        </Link>
    );
}
