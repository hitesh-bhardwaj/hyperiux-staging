...
export const Facebook = ({ className = "", menuSocial, fill }) => {
  ...
  return (
    <div
      className={`rounded-full overflow-hidden socials cursor-pointer  relative border border-black-1 w-fit h-fit group hover:border-primary duration-300 ease-in-out ${menuSocial ? "menusocials" : ""}`}
