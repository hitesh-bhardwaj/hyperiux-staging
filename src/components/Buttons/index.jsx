...
export const Facebook = ({ className = "", menuSocial, fill, href = "/" }) => {
  ...
  return (
    <Link
      ...
      className={`rounded-full overflow-hidden socials cursor-pointer relative border border-white w-fit h-fit group duration-500 ease-in-out flex items-center justify-center
        ${menuSocial ? "menusocials" : "hover:border-[#ff5f00]"}`}
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
    >
      <span
        ...
        style={{
          ...
          backgroundColor: menuSocial ? '#ffffff' : '#ff5f00',
        }}
      />
      <svg
...
export const Instagram = ({ className = "", menuSocial, fill, href = "/" }) => {
  const spanRef = useRef(null);
...
export const Linkedin = ({ className = "", menuSocial, fill, href = "/" }) => {
  const spanRef = useRef(null);
    ...
    >
      ...
      >
        <g clipPath="url(#clip0_2939_2717)">
          <path className={`duration-500 ease-in-out ${fill}`} d="M21.1284 32.6877C21.1284 28.8681 21.1284 25.0599 21.1284 21.2403C21.1284 21.1499 21.1284 21.0595 21.1284 20.9465C22.2924 20.9465 23.445 20.9465 24.6315 20.9465C24.6315 21.4663 24.6315 21.9862 24.6315 22.5173C24.8801 22.2235 25.0948 21.9297 25.3548 21.6811C25.9989 21.0708 26.7786 20.7544 27.6487 20.6753C28.4059 20.6075 29.163 20.664 29.8975 20.89C31.0954 21.2742 31.8412 22.1105 32.1576 23.297C32.3158 23.9072 32.3723 24.5514 32.474 25.1729C32.4966 25.2972 32.5079 25.4215 32.5192 25.5571C32.5192 27.9189 32.5192 30.292 32.5192 32.6538C31.3101 32.6538 30.0896 32.6538 28.8579 32.6538C28.8579 32.5521 28.8579 32.4617 28.8579 32.3826C28.8579 30.4389 28.8692 28.5065 28.8466 26.5628C28.8466 26.0882 28.7788 25.6023 28.6771 25.139C28.5415 24.5062 28.1686 24.0541 27.5018 23.9072C27.2306 23.8507 26.9481 23.8394 26.6656 23.862C25.7503 23.9298 25.1513 24.4158 24.9479 25.3085C24.8349 25.817 24.7784 26.3594 24.7784 26.8793C24.7558 28.8229 24.7671 30.7553 24.7671 32.699C23.5693 32.6877 22.3489 32.6877 21.1284 32.6877Z" fill="currentColor" />
          <path className={`duration-500 ease-in-out ${fill}`} d="M15.1946 32.6864C15.1946 30.2117 15.1946 27.7482 15.1946 25.2734C15.1946 23.9173 15.1946 22.55 15.1946 21.1939C15.1946 21.1148 15.1946 21.0357 15.1946 20.9453C16.415 20.9453 17.6129 20.9453 18.8446 20.9453C18.8446 21.0357 18.8446 21.1261 18.8446 21.2165C18.8446 25.0022 18.8446 28.7991 18.8446 32.5847C18.8446 32.6186 18.8446 32.6525 18.8446 32.6864C17.6355 32.6864 16.415 32.6864 15.1946 32.6864Z" fill="currentColor" />
          <path className={`duration-500 ease-in-out ${fill}`} d="M19.1267 17.2045C19.1041 18.4024 18.1322 19.3403 16.957 19.3064C15.8269 19.2838 14.8777 18.2894 14.9003 17.1367C14.9229 15.9841 15.906 15.0462 17.0587 15.0688C18.2226 15.1027 19.1493 16.0519 19.1267 17.2045Z" fill="currentColor" />
        </g>
        <defs>
          <clipPath id="clip0_2939_2717">
            <rect width="19" height="18" fill="currentColor" transform="translate(14 15)" />
          </clipPath>
        </defs>
      </svg>
    </Link>
...
export const Twitter = ({ className = "", menuSocial, fill, href = "/" }) => {
  const spanRef = useRef(null);
