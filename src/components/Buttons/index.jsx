...
export const Facebook = ({ className = "", menuSocial, fill }) => {
  ...
  return (
    <div
      className={`rounded-full overflow-hidden socials cursor-pointer hover:bg-[#ff5f00] hover:border-[#ff5f00]  relative border border-white w-fit h-fit group duration-500 ease-in-out ${menuSocial ? "menusocials" : ""}`}
    ...
    >
      ...
      >
        <g clipPath="url(#clip0_2939_2713)">
          <path
            className={`duration-500 ease-in-out ${fill} `}
...
export const Instagram = ({ className = "", menuSocial, fill }) => {
  ...
  return (
    <div
      className={`rounded-full overflow-hidden socials cursor-pointer hover:bg-[#ff5f00] hover:border-[#ff5f00]  relative border border-white w-fit h-fit group hover:border-primary duration-500 ease-in-out ${menuSocial ? "menusocials" : ""}`}
      onMouseEnter={handleMouseMove}
      onMouseLeave={handleMouseMove}
    >
      <svg
