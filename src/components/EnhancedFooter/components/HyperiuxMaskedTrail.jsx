...
import {
  HYPERIUX_LETTER_MASK_STYLE,
  MASK_OUTLINE_CHARS,
} from "../data";
import OrangeLiquidTrailCanvas from "./OrangeLiquidTrailCanvas";
...
export default function HyperiuxMaskedTrail({
    speed = 1,
    overlayOpacity = 1,
    trailLerp = 0.22,
    trailWidth = 40,
    ...
    return (
        <div
            ref={bottomFooterRef}
            className={`w-screen h-[20vw] max-sm:h-[30vh] bottom-footer relative z-2 ${className}`}
        >
            <div className="flex h-[20vw] justify-between items-center w-full px-[5vw] max-sm:flex-col max-sm:pt-[10%] max-sm:pb-[5%] max-sm:h-[30vh]">
                <div className="flex flex-col">
                    <HyperiuxMaskedLetterSlot
                        bottomFooterRef={bottomFooterRef}
                        speed={speed}
                        overlayOpacity={overlayOpacity}
                        trailLerp={trailLerp}
                        trailWidth={trailWidth}
...
function HyperiuxMaskedLetterSlot({
    // bottomFooterRef,
    // speed,
    // overlayOpacity,
    // trailLerp,
    ...
    return (
        <div
            ...
            style={HYPERIUX_LETTER_MASK_STYLE}
        >
            {/* <HyperiuxTrailCanvas
                speed={speed}
                overlayOpacity={overlayOpacity}
