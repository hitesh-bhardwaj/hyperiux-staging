...
const stickyItems = [
  ...
  },
  {
    ...
    href: "#",
    paragraph:
      "Thoughtfully crafted digital experiences that seamlessly blend clarity, usability, and visual systems — creating interfaces where design improves every decision.",
    solutions: [
      "PRODUCT DESIGN",
      "INTERFACE DESIGN",
      "DESIGN SYSTEMS",
  ...
  },
  {
    ...
    href: "#",
    paragraph:
      "We align business goals, user expectations, and product direction into a practical roadmap for digital growth, conversion, and long-term experience value.",
    solutions: [
      "UX STRATEGY",
      "EXPERIENCE AUDIT",
      "CRO ROADMAP",
  ...
  },
  {
    ...
    href: "#",
    paragraph:
      "From conversion journeys to refined content systems, every detail is designed to help brands turn attention into trust, action, and measurable commercial outcomes.",
    solutions: [
