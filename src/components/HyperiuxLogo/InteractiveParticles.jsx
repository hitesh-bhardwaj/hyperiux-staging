...
export function InteractiveParticles({
  ...
  */
  ...
  const raycastPointer = useMemo(() => new THREE.Vector2(), []);
  ...
  useFrame(() => {
    ...
    const activePositionStrength = input.isMobile
      ? gyroPositionStrength ?? parallaxPositionStrength
      : parallaxPositionStrength;

    const activeRotationStrength = input.isMobile
      ? gyroRotationStrength ?? parallaxRotationStrength
    ...
    */
    ...
    const targetPosY =
      ...
      (isHolding ? 0 : inputY * activePositionStrength);
    ...
    targetEuler.set(
      isHolding ? 0 : -inputY * activeRotationStrength,
      isHolding ? 0 : inputX * activeRotationStrength,
      0,
      "XYZ"
    );
    ...
    group.quaternion.slerp(targetQuat, parallaxLerp);
